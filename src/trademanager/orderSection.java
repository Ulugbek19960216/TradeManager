 ...
 * @author admin
 */
public class orderSection extends javax.swing.JDialog {

    /**
     * Creates new form OrderPage1
     */
    public orderSection(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    }
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                orderSection dialog = new orderSection(new javax.swing.JFrame(), true);
